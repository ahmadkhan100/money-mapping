...
const Footer = () => {
	const socials = [
		{
			name: 'GitHub',
			url: 'https://github.com/ahmadkhan100',
			icon: <Github className="h-[1.5rem] w-[1.5rem]" />,
		},
		{
			name: 'LinkedIn',
			url: 'https://www.linkedin.com/in/ahmad-khan-b6584b225/',
			icon: <Linkedin className="h-[1.5rem] w-[1.5rem]" />,
		},
		{
			name: 'Email',
			url: 'mailto:ahmadkhanlmb100@gmail.com',
			icon: <Mail className="h-[1.5rem] w-[1.5rem]" />,
		},
		{
			name: 'Source Code',
			url: 'https://github.com/ahmadkhan100/money-mapper',
